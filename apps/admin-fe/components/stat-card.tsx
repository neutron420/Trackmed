...
// Enhanced Mantis-style stat card with more features
...
export function MantisStatCard({
  title,
  value,
  percentage,
  isLoss = false,
  ...
  return (
    <div className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
      <div className="flex items-center justify-between">
        <div>
          ...
          <div className="mt-1 flex items-baseline gap-2">
            ...
            {percentage !== undefined && (
              <span className={`flex items-center text-xs font-medium ${isLoss ? "text-red-600" : "text-emerald-600"}`}>
                {isLoss ? (
        ...
        {icon && (
          <div className={`flex h-12 w-12 items-center justify-center rounded-lg ${colorMap[color].bg}`}>
