...
const bgColors = {
  batch: "bg-emerald-50 text-emerald-600",
  shipment: "bg-blue-50 text-blue-600",
    ...
    <div className="space-y-3">
      {activities.map((activity) => (
        <div key={activity.id} className="flex gap-3">
          <div className={`flex h-7 w-7 shrink-0 items-center justify-center rounded-lg ${bgColors[activity.type]}`}>
            {icons[activity.type]}
          </div>
