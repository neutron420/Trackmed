...
export default function ManufacturerLoginPage() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      if (data.data.user.role !== "MANUFACTURER") {
        throw new Error("Access denied. Manufacturer account required.");
      }
      ...
      <div className="hidden lg:flex lg:w-[45%] relative overflow-hidden bg-white">
        <div className="absolute inset-0">
          <div
            ...
            style={{
              background:
                "linear-gradient(135deg, rgba(37, 99, 235, 0.75) 0%, rgba(59, 130, 246, 0.6) 25%, rgba(96, 165, 250, 0.45) 50%, rgba(147, 197, 253, 0.3) 75%, rgba(219, 234, 254, 0.15) 90%, transparent 100%)",
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(135deg, rgba(14, 165, 233, 0.7) 0%, rgba(56, 189, 248, 0.55) 25%, rgba(125, 211, 252, 0.4) 50%, rgba(186, 230, 253, 0.25) 75%, transparent 100%)",
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(135deg, rgba(59, 130, 246, 0.65) 0%, rgba(96, 165, 250, 0.5) 30%, rgba(147, 197, 253, 0.35) 60%, rgba(219, 234, 254, 0.2) 85%, transparent 100%)",
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(135deg, rgba(67, 56, 202, 0.6) 0%, rgba(99, 102, 241, 0.45) 40%, rgba(129, 140, 248, 0.3) 70%, transparent 100%)",
          ...
          <div
            ...
            style={{
              background:
                "radial-gradient(circle, rgba(37, 99, 235, 0.6) 0%, rgba(59, 130, 246, 0.45) 30%, rgba(96, 165, 250, 0.3) 60%, rgba(147, 197, 253, 0.15) 85%, transparent 100%)",
              filter: "blur(65px)",
            }}
          />
          ...
          <div
            ...
            style={{
              background:
                "radial-gradient(circle, rgba(14, 165, 233, 0.55) 0%, rgba(56, 189, 248, 0.4) 40%, rgba(125, 211, 252, 0.25) 70%, transparent 90%)",
              filter: "blur(60px)",
            }}
          />
        </div>
